package br.com.acsousa.aws_project01.service;
...
import br.com.acsousa.aws_project01.model.Envelope;
import br.com.acsousa.aws_project01.model.Product;
import br.com.acsousa.aws_project01.model.ProductEvent;
...
public class ProductPublisher {
    ...
    public void publishProductEvent(Product product, EventType eventType, String username) {
        ...
        try {
            ...
            LOG.info("Product event published - MessageId: {}", publishResult.getMessageId());
